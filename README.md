...
I build tools, web projects, and the occasional native compatibility thing when something useful is missing.

Most of my work is Python and JavaScript, with C/C++ showing up when the job needs it.
